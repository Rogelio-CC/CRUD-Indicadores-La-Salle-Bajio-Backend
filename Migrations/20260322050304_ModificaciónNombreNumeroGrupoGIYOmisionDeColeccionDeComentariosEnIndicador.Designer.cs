...
namespace KPIBackend.Migrations
{
    ...
    [Migration("20260322050304_ModificaciónNombreNumeroGrupoGIYOmisionDeColeccionDeComentariosEnIndicador")]
    partial class ModificaciónNombreNumeroGrupoGIYOmisionDeColeccionDeComentariosEnIndicador
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KPIBackend.Models.Comentario", b =>
                {
                    b.HasOne("KPIBackend.Models.Actividad", null)
                    ...
                    b.HasOne("KPIBackend.Models.Directriz", null)
                        .WithMany("Comentarios")
                        .HasForeignKey("DirectrizId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("KPIBackend.Models.Estrategia", null)
                        .WithMany("Comentarios")
                        .HasForeignKey("EstrategiaId")
                        .OnDelete(DeleteBehavior.Restrict);
